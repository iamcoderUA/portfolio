...
function slider() {
  ...
  var slideItems = [{ imgUrl: 'img/content/slider-1.png', slideCaption: 'Корпоративный сайт фитнес-центра', technology: 'HTML5, CSS3, БЭМ, Git', slideUrl: 'https://iamcoderua.github.io/Afrodita/' }, { imgUrl: 'img/content/slider-2.png', slideCaption: 'Лендинг ресторана бургеров', technology: 'pug, sass, JavaScript, jQuery, AJAX, Gulp4, WebPack3, Git', slideUrl: 'https://iamcoderua.github.io/burger/prod/' }, { imgUrl: 'img/content/slider-3.jpg', slideCaption: 'Сайт-визитка психоаналитика, SPA (в разработке)', technology: 'pug, sass, VanillaJS, VueJS, AJAX, node.js, PHP, MongoDB, WebPack3, Git', slideUrl: '' }, { imgUrl: 'img/content/slider-4.png', slideCaption: 'Мой сайт портфолио', technology: 'pug, sass, VanillaJS, AJAX, VueJS, node.js, MongoDB, Gulp, WebPack, Git', slideUrl: 'http://iamcoder.in.ua' }];
