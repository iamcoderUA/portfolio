...
if (document.getElementsByClassName('feed-form').length > 0) {
	...
	var submitBtn = document.querySelector('.form-row__homelink');
...
function slider() {
  ...
  var slideItems = [{ imgUrl: '../img/content/slider-1.png', slideCaption: 'LoftSchool Школа онлайн образования', technology: 'HTML5, CSS3, БЭМ', slideUrl: 'https://vk.com' }, { imgUrl: '../img/content/slider-2.jpg', slideCaption: 'Сайт портфолио', technology: 'pug, sass, GRID, JavaScript, node.js, VueJS, Gulp, WebPack', slideUrl: 'https://vk.com' }, { imgUrl: '../img/content/slider-3.jpg', slideCaption: 'Корпоративный сайт', technology: 'pug, sass, JavaScript, node.js, VueJS, Gulp, WebPack', slideUrl: 'https://vk.com' }, { imgUrl: '../img/content/slider-4.png', slideCaption: 'Бургер лендинг', technology: 'HTML5, SASS, JavaScript, jQuery, AJAX, PHP, Gulp', slideUrl: 'https://vk.com' }];
...
function formValid() {
    ...
    var form = document.querySelector('.form');
    var rows = form.getElementsByClassName('form-row');
    var inputs = [];
    ...
    return {
        submitForm: function submitForm() {
            for (var _i = 0; _i < inputs.length; _i++) {
                if (inputs[_i].value === "" || inputs[_i].value === " ") {
                    if (inputs[_i] === inputs[1]) {
                        regexp.test(inputs[1]);
                    }

                    inputs[_i].style.border = '1px solid red';
                    error.classList.add('active');

                    for (var _i2 = 0; _i2 < popBtns.length; _i2++) {
                        popBtns[_i2].addEventListener('click', function (e) {
                            e.preventDefault();
